...
# I planned to organise the data and find dependencies. I would also take note of any null values, anomalies that may affect the data set.
# 
...
# There are 3 non-numeric data types, two of which are date aand time. There are no null values. store_and_fwd_flag is a 'N' and could be binary 'Y' / 'N'
# 
# The distribution of fare amount and trip distancelooks skewed. There is negative amount which could be an error or a refund.
...
payment_df = df.groupby('payment_type').count()
payment_df
