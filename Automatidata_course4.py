...
# 
# reject the null hypthosis as the p value is smaller than the level of significance
...
# ==> ENTER YOUR RESPONSE HERE 
# 
# Paying with credit card generates more revenue
# There are multitude of different factors that may affect the pay amount such as customer preferences or amount of cash they have on hand. The assumptions were made that all customers follow a fixed routine of payment method.
